...
def config_parser():
    ...
    parser.add_argument("--scale_split", type=lambda s: [int(item) for item in s.split(',')], default=[363,182,93,0], help='split index of each scale, mannually set for now')
...
if __name__ == '__main__':
    ...
    with open(os.path.join(args.datadir, 'begin (3).json'), 'r') as f:
        data = json.load(f)
